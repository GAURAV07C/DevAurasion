            ...
            >
              ...
              <CardContent className="absolute inset-0 flex flex-col justify-end p-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <CardHeader className="text-start">
                  <CardTitle className="text-lg sm:text-xl lg:text-2xl font-bold text-[#5D5A88]">
                    {person.name}
                  </CardTitle>
                  <CardDescription className="text-sm sm:text-base lg:text-lg font-bold text-[#8D8BA7]">
                    {person.role}
                  </CardDescription>
                </CardHeader>
                <CardFooter className="flex gap-4 mt-2 text-[#8D8BA7]">
